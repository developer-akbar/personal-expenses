...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function calculateExpensesByCategory(expenses) {
        const expensesFiltered = expenses.filter(expense => expense["Income/Expense"] === "Expense");
    ...
    function generateYearlyExpenseReports(expenses) {
        const yearlyExpenses = groupExpensesByYear(expenses);
    ...
    function generateMonthlyExpenseReports(expenses) {
    ...
    loadCSV(function (csv) {
        ...
        generateReports(masterExpenses);
        convertAmountToINR();
    ...
    function generateExpenseTable(expenses) {
        ...
        for (const year in expenses[Object.keys(expenses)[0]]) {
    ...
    function generateReports(expenses) {
        ...
        years.forEach(year => {
            ...
            const yearTotalExpenses = groupExpensesByYear(expenses);
            const yearTotal = document.createElement('p');
        ...
        categories.forEach(category => {
            ...
            const categoryTotalExpenses = calculateExpensesByCategory(expenses);
